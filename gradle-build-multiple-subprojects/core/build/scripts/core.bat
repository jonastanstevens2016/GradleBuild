...
set CLASSPATH=%APP_HOME%\lib\core-1.0.jar;%APP_HOME%\lib\web-1.0.jar

@rem Execute core
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CORE_OPTS%  -classpath "%CLASSPATH%" mainpackage.Main %CMD_LINE_ARGS%
